import { h as WORKER_OFFSCREEN_CANVAS } from "./dom-Dyj-SAyk.js";
import { Dt as getTopLeft, G as clamp, J as modulo, K as floor, L as METERS_PER_UNIT, St as getCorner, W as ceil, at as containsCoordinate, kt as getWidth, lt as createOrUpdate, m as equivalent, wt as getHeight, y as get } from "./proj-De_LZ0k8.js";
import { A as assert, S as linearFindNearest, _ as BaseEvent, g as EventType_default, i as getUid, r as abstract, x as isSorted } from "./Object-cXVcveXE.js";
import { t as intersectsLinearRing } from "./intersectsextent-BO51DrTL.js";
import { i as withinExtentAndZ, n as getCacheKey, r as hash, t as createOrUpdate$1 } from "./tilecoord-DnIcLTzu.js";
import { i as Source, n as expandUrl, r as renderXYZTemplate } from "./uri-CFpgHLK0.js";
import { i as TileState_default, n as scale, r as toSize } from "./size-doXthUyZ.js";
import { i as ImageTile, n as TileRange, r as createOrUpdate$2, t as ReprojTile } from "./Tile-BzNAmMrm.js";
...
var TileGrid = class {
	...
	getTileCoordChildTileRange(tileCoord, tempTileRange, tempExtent) {
		if (tileCoord[0] < this.maxZoom) {
			if (this.zoomFactor_ === 2) {
				...
				return createOrUpdate$2(minX, minX + 1, minY, minY + 1, tempTileRange);
			}
	...
	*/
	getTileRangeForTileCoordAndZ(tileCoord, z, tempTileRange) {
		...
		if (z === tileCoordZ) return createOrUpdate$2(tileCoordX, tileCoordY, tileCoordX, tileCoordY, tempTileRange);
		if (this.zoomFactor_) {
			const factor = Math.pow(this.zoomFactor_, z - tileCoordZ);
			const minX = Math.floor(tileCoordX * factor);
			const minY = Math.floor(tileCoordY * factor);
			if (z < tileCoordZ) return createOrUpdate$2(minX, minX, minY, minY, tempTileRange);
			return createOrUpdate$2(minX, Math.floor(factor * (tileCoordX + 1)) - 1, minY, Math.floor(factor * (tileCoordY + 1)) - 1, tempTileRange);
		}
