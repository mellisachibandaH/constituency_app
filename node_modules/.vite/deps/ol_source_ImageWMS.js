import { g as ImageState_default } from "./dom-Dyj-SAyk.js";
import { A as transform, Ct as getForViewAndSize, K as floor, Mt as isEmpty, Tt as getIntersection, U as compareVersions, W as ceil, Y as round, kt as getWidth, m as equivalent, ot as containsExtent, pt as equals, wt as getHeight, xt as getCenter, y as get } from "./proj-De_LZ0k8.js";
import { S as linearFindNearest, _ as BaseEvent, c as unlistenByKey, g as EventType_default, o as listen } from "./Object-cXVcveXE.js";
import { n as decode, t as ImageWrapper } from "./Image-CE6-xAjG.js";
import { a as ERROR_THRESHOLD, c as calculateSourceResolution, o as Triangulation, u as render } from "./tilecoord-DnIcLTzu.js";
import { i as Source, t as appendParams } from "./uri-CFpgHLK0.js";
...
var ReprojImage = class extends ImageWrapper {
	...
	*/
	reproject_() {
		...
		if (sourceState == ImageState_default.LOADED) this.canvas_ = render(getWidth(this.targetExtent_) / this.targetResolution_, getHeight(this.targetExtent_) / this.targetResolution_, this.sourcePixelRatio_, fromResolutionLike(this.sourceImage_.getResolution()), this.maxSourceExtent_, this.targetResolution_, this.targetExtent_, this.triangulation_, [{
...
//#endregion
//#region node_modules/ol/source/wms.js
/**
...
function getRequestUrl(baseUrl, extent, size, projection, params) {
	...
	params["BBOX"] = (v13 && axisOrientation.startsWith("ne") ? [
		extent[1],
		extent[0],
		extent[3],
		extent[2]
...
function createLoader(options) {
	...
	return (extent, resolution, pixelRatio) => {
		...
		if (pixelRatio != 1 && (!hidpi || options.serverType === void 0)) pixelRatio = 1;
...
function getFeatureInfoUrl(options, coordinate, resolution) {
	...
	const x = floor((coordinate[0] - extent[0]) / resolution, 4);
	const y = floor((extent[3] - coordinate[1]) / resolution, 4);
...
function getLegendUrl(options, resolution) {
	...
	if (resolution !== void 0) baseParams["SCALE"] = resolution * (get(options.projection || "EPSG:3857").getMetersPerUnit() || 1) / 28e-5;
...
//#endregion
//#region node_modules/ol/source/ImageWMS.js
/**
...
* @api
*/
var ImageWMS = class extends ImageSource {
	/**
