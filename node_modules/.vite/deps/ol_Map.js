import { c as replaceNode, f as MAC, g as ImageState_default, h as WORKER_OFFSCREEN_CANVAS, i as isCanvas, m as WEBKIT, n as createMockDiv, o as removeChildren, p as PASSIVE_EVENT_LISTENERS, r as getSharedCanvasContext2D, s as replaceChildren, t as createCanvasContext2D, u as DEVICE_PIXEL_RATIO } from "./dom-Dyj-SAyk.js";
import { d as disable, f as Polygon, p as ViewHint_default, t as View } from "./View-OIpaXn5D.js";
import { B as rotate, Ct as getForViewAndSize, D as toUserCoordinate, F as isEmpty, G as clamp, H as wrapX, Mt as isEmpty$1, P as clear, Tt as getIntersection, V as scale, g as fromUserCoordinate, kt as getWidth, pt as equals, rt as clone, tt as warn, ut as createOrUpdateEmpty } from "./proj-De_LZ0k8.js";
import { A as assert, C as apply, D as fromString, O as makeInverse, T as create, _ as BaseEvent, c as unlistenByKey, d as TRUE, f as VOID, g as EventType_default$1, h as Disposable, i as getUid, l as Target, m as toPromise, n as ObjectEventType_default, o as listen, r as abstract, t as BaseObject, u as FALSE, v as ascending, w as compose, y as equals$1 } from "./Object-cXVcveXE.js";
import { a as RenderEvent, c as asString, d as rgbaToLcha, f as toString, i as EventType_default$2, l as fromString$1, n as inView, o as NO_COLOR, p as withAlpha, r as BaseLayer, s as asArray, t as Layer, u as lchaToRgba } from "./Layer-B2Lq6CxD.js";
import { a as easeOut, s as linear } from "./intersectsextent-BO51DrTL.js";
import { r as decodeFallback } from "./Image-CE6-xAjG.js";
import { i as TileState_default, r as toSize, t as hasArea } from "./size-doXthUyZ.js";
...
function parse(encoded, expectedType, context) {
	switch (typeof encoded) {
		...
		case "string":
			if (isType(expectedType, ColorType)) return new LiteralExpression(ColorType, fromString$1(encoded));
			if (isType(expectedType, BooleanType)) return new LiteralExpression(BooleanType, !!encoded);
...
var IconImage = class extends Target {
	...
	*/
	dispatchChangeEvent_() {
		this.dispatchEvent(EventType_default$1.CHANGE);
	}
	/**
	* @private
	*/
			...
			if (this.imageState_ === ImageState_default.LOADED || this.imageState_ === ImageState_default.ERROR) resolve();
				...
				const onChange = () => {
					if (this.imageState_ === ImageState_default.LOADED || this.imageState_ === ImageState_default.ERROR) {
						this.removeEventListener(EventType_default$1.CHANGE, onChange);
						resolve();
					}
				};
				this.addEventListener(EventType_default$1.CHANGE, onChange);
			}
		});
		return this.ready_;
	}
...
var Icon = class Icon extends ImageStyle {
	...
	*/
	listenImageChange(listener) {
		this.iconImage_.addEventListener(EventType_default$1.CHANGE, listener);
	}
	/**
	* Load not yet loaded URI.
	...
	*/
	unlistenImageChange(listener) {
		this.iconImage_.removeEventListener(EventType_default$1.CHANGE, listener);
	}
	/**
	* @override
	*/
	...
	renderFrame_(time) {
		...
		if (frameState) {
			...
			if (previousFrameState) {
				if (!this.previousExtent_ || !isEmpty$1(this.previousExtent_) && !equals(frameState.extent, this.previousExtent_)) {
